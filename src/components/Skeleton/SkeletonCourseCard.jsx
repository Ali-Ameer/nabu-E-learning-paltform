...
export const SkeletonCourseCard = React.memo(({customClass}) => {
  
  return (
    <div role="status" className={`max-w-sm p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700 ${customClass}`}>
